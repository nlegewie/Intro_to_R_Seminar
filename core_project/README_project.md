...
├── data/                   ← Datensätze
├── scripts/                ← R-Skripte
│   ├── 01_clean_data.R     ← Daten einlesen und bereinigen
│   ├── 02_analysis.R       ← Analyse und Visualisierung
│   └── 03_helpers.R        ← Hilfsfunktionen (brauchst du erst später)
├── reports/                ← R-Markdown-Dokumente
│   └── analysis_report.Rmd ← Wird im Laufe des Semesters aufgebaut
...
|--------|-----------------|
| `01_clean_data.R` | Daten einlesen, filtern, bereinigen, umstrukturieren |
| `02_analysis.R` | Zusammenfassungen, Grafiken, statistische Auswertungen |
| `03_helpers.R` | Wiederverwendbare Funktionen (erst ab Semestermitte relevant) |
...
5. **Hausaufgaben fertigstellen** — zu Hause die Analyse abschließen und abgeben

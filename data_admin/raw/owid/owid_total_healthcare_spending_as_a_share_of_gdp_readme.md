# Total healthcare spending as a share of GDP - Data package

This data package contains the data that powers the chart ["Total healthcare spending as a share of GDP"](https://ourworldindata.org/explorers/global-health?Health+Area=Health+systems&Indicator=Total+expenditure+on+health&Metric=Number+of+deaths&Source=UN+WPP&country=OWID_WRL~CHN~ZAF~BRA~USA~GBR~IND~RWA) on the Our World in Data website. It was downloaded on January 25, 2026.
...
#### Full citation
World Health Organization - Global Health Observatory (2025) – processed by Our World in Data. “Current health expenditure (CHE) as percentage of gross domestic product (GDP) (%)” [dataset]. World Health Organization, “Global Health Observatory” [original data].

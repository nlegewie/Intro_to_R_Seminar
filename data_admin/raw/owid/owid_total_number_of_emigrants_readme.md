# Total number of emigrants - Data package

This data package contains the data that powers the chart ["Total number of emigrants"](https://ourworldindata.org/explorers/migration?Metric=International+emigrants&Period=Total+number&Sub-Metric=Total&Age=All+ages&country=CAN~FRA~DEU~GBR~USA~IND~CHN~SYR~YEM) on the Our World in Data website. It was downloaded on January 23, 2026.
...
People that were born in a country but now live in another country.
...
#### Full citation
United Nations Department of Economic and Social Affairs (2024) – with minor processing by Our World in Data. “Total number of emigrants” [dataset]. United Nations Department of Economic and Social Affairs, “International Migrant Stock 2024 - POP/DB/MIG/Stock/Rev.2024” [original data].
